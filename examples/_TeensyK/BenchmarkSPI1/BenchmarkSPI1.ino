...
/*
  ...
  Teensy 3.0 -> 3.2
	MOSI:  11// or alternative 7
	SCK:   13// or alternative 14
  Teensy K64/66
	Same as Teensy 3.0 -> 3.2 (included alternative pins)
	For use SPI1
		MOSI = 0
		SCLK = 32
		DC = 6
		CS = any pin
  ESP8266-----------------------------------
	#define __CS  4   //or any other compatible pin
	#define __DC  5   //or any other compatible pin
	MOSI: D7
	SCLK: D5
*/
#if defined(ESP8266)
...
TFT_ST7735 tft = TFT_ST7735(10,6,255,0,32);//Teensy K66 SPI1!!!
