...
#define CMD_NORML   	0x13//Normal Display ON										CMD_NORON
#define CMD_DINVOF  	0x20//Display Inversion OFF									CMD_INVOFF
#define CMD_DINVON   	0x21//Display Inversion ON									CMD_INVON
...
#define CMD_PARTAREA	0x30//Partial Area											CMD_PTLAR
#define CMD_VSCLLDEF	0x33//Vertical Scroll Definition							
#define CMD_TEFXLON		0x35//Tearing Effect Line ON								CMD_TEON
#define CMD_TEFXLOF		0x34//Tearing Effect Line OFF								CMD_TEOFF
...
#define CMD_PWCTR6  	0xFC//Power_Control6										NEW!!!!!!!!!!!!!
...
#define CMD_RDID1   	0xDA//														NEW!!!!!!!!!!!!!
#define CMD_RDID2   	0xDB//														NEW!!!!!!!!!!!!!
#define CMD_RDID3   	0xDC//														NEW!!!!!!!!!!!!!
#define CMD_RDID4   	0xDD//														NEW!!!!!!!!!!!!!
